let EventCreatedTemplate = (instance, userName) => {
...
This notification is to inform you that Event : ${EventTitle} has been created successfully,</p>
...
<br/>
<p style="line-height: 140%;">If you want to reschedule the notification, edit event or change events's priority, you can find these settings in MyCal.com dashboard's Edit Section</p>
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <h1 style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: Bitter; font-size: 22px; "> You will recieve a reminder 30 minutes before the event as scheduled.  </h1>
      </td>
    </tr>
  </tbody>
</table>
...
module.exports = { EventCreatedTemplate };